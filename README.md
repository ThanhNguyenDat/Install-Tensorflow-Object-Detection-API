...
Or you only download and extract file [here](https://drive.google.com/file/d/1WgWjp6OOpT5FVKhSB35TEuplSrqbrgny/view?usp=sharing). Then you set variable `PYTHONPATH` in System variables
